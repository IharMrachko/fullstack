...
let AnalyticsPageComponent = class AnalyticsPageComponent {
    ...
    ngAfterViewInit() {
        ...
        this.service.getAnalytics().subscribe((data) => {
...
let PositionFormComponent = class PositionFormComponent {
...
PositionFormComponent.ctorParameters = () => [
...
let OrderPageComponent = class OrderPageComponent {
    constructor(router, orderService, ordersService) {
        this.router = router;
    ...
    submit() {
        ...
        this.ordersService.create(order).subscribe(newOrder => {
...
let OrderPositionsComponent = class OrderPositionsComponent {
    constructor(router, positionsService, order) {
        this.router = router;
        this.positionsService = positionsService;
        this.order = order;
    }
    ngOnInit() {
        this.positions$ = this.router.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((params) => {
...
let OrderService = class OrderService {
    ...
    remove(orderPosition) {
        const ind = this.list.findIndex(p => p._id === orderPosition._id);
